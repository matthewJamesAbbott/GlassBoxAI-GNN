//
// Matthew Abbott
// Graph Neural Network - OpenCL Implementation
// C++ wrapper with OpenCL GPU acceleration
// Single file - all kernels embedded
//
...
void PrintUsage() {
    cout << "GNN-OpenCL - Command-line Graph Neural Network (GPU-Accelerated)\n\n";
    cout << "Commands:\n";
    cout << "  create   Create a new GNN model\n";
    cout << "  train    Train an existing model with graph data\n";
    cout << "  predict  Make predictions with a trained model\n";
    cout << "  info     Display model information\n";
    cout << "  help     Show this help message\n\n";
    cout << "Create Options:\n";
    cout << "  --feature=N            Input feature size (required)\n";
    cout << "  --hidden=N             Hidden layer size (required)\n";
    cout << "  --output=N             Output size (required)\n";
    ...
    cout << "  --graph=FILE           Graph file (JSON format) (required)\n";
    cout << "  --save=FILE            Save trained model to file (required)\n";
    cout << "  --epochs=N             Number of training epochs (default: 100)\n";
    cout << "  --lr=VALUE             Override learning rate\n";
    cout << "  --verbose              Show training progress\n\n";
    cout << "Predict Options:\n";
    cout << "  --model=FILE           Model file to load (required)\n";
    cout << "  --graph=FILE           Graph file (required)\n\n";
    cout << "Info Options:\n";
    cout << "  --model=FILE           Model file to load (required)\n\n";
    cout << "Examples:\n";
    cout << "  gnn_opencl create --feature=3 --hidden=16 --output=2 --mp-layers=2 --save=model.bin\n";
    cout << "  gnn_opencl train --model=model.bin --graph=data.json --epochs=500 --save=trained.bin\n";
    cout << "  gnn_opencl predict --model=trained.bin --graph=data.json\n";
    cout << "  gnn_opencl info --model=trained.bin\n";
}
